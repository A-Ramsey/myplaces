...
<x-text-input id="latitude" name="latitude" type="number" step="0.00000001" class="hidden" :value="old('latitude')" required autofocus autocomplete="latitude" />
<x-text-input id="longitude" name="longitude" type="number" step="0.00000001" class="hidden" :value="old('longitude')" required autofocus autocomplete="longitude" />

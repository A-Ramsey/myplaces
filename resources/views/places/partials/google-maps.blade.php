...
<x-text-input id="latitude" name="latitude" type="number" class="hidden" :value="old('latitude')" required autofocus autocomplete="latitude" />
<x-text-input id="longitude" name="longitude" type="number" class="hidden" :value="old('longitude')" required autofocus autocomplete="longitude" />
